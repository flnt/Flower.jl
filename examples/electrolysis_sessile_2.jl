...
plot_python_pdf(max.((phL.trans_scal[:,:,2] .-c0_KOH)./c0_KOH,0.0), "KOH",plot_levelset,10,range=none)

plot_python_pdf(max.((phL.trans_scal[:,:,3] .-c0_H2O)./c0_H2O,0.0), "H2O",plot_levelset,10),range=none
...
python_movie_zoom(max.((fwd.trans_scal[:,:,:,1] .-c0_H2)./c0_H2,0.0),"H2_norm",plot_levelset,size_frame,1,gp.nx,1,gp.ny,0,range(0,1400,length=8))

python_movie_zoom(max.((fwd.trans_scal[:,:,:,2] .-c0_KOH)./c0_KOH,0.0),"KOH_norm",plot_levelset,size_frame,1,gp.nx,1,gp.ny,10,range=none)

python_movie_zoom(max.((fwd.trans_scal[:,:,:,3] .-c0_H2O)./c0_H2O,0.0),"H2O_norm",plot_levelset,size_frame,1,gp.nx,1,gp.ny,10,range=none)

python_movie_zoom(fwd.saved_scal[:,:,:,1],"flux1",false,size_frame,1,gp.nx,1,gp.ny,10,range=none)

python_movie_zoom(fwd.saved_scal[:,:,:,2],"flux2",false,size_frame,1,gp.nx,1,gp.ny,10,range=none)
