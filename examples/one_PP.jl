...
JLD2.@load "/media/tf/be46b01f-eb0c-4298-a160-d10e4e87b3b9/rayleigh-data/St_0.36-nx_80-ny_640-ratio_8-maxiter_1.0e+05-TM_0.1-T1_1.0-T2_0.0-λ_2.5-Ra_1.0e+03.jld2"
...
record(fp, "/home/tf/All/Soutenance/TM$(TM)_St$(St)_LH$(LH)_Ra_$(@sprintf("%.1e", Ra)).mp4", timestamps;
